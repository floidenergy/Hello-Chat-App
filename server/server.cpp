...
public:
    ...
    virtual void OnClientConnect(std::shared_ptr<jai::net::Connection<Message_id>> Cn){
        ...
        // Init New Connected Client On The Server And Generate his Unique ID
        Cn->Recieve();
        {
        ...
        std::cout << "[" << Cn->UserInfo.GetUserName() << "] Has Been Connected : " << Connections.size() << " Clients Remaining" << std::endl;
